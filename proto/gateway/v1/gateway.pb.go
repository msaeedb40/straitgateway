...
const file_gateway_v1_gateway_proto_rawDesc = "" +
	"\n" +
	"\x18gateway/v1/gateway.proto\x12\x18straitgateway.gateway.v1\"\x15\n" +
	"\x13ListGatewaysRequest\"Y\n" +
	"\x14ListGatewaysResponse\x12A\n" +
	"\bgateways\x18\x01 \x03(\v2%.straitgateway.gateway.v1.GatewayInfoR\bgateways\"\xde\x01\n" +
	"\vGatewayInfo\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1c\n" +
	"\tnamespace\x18\x02 \x01(\tR\tnamespace\x12#\n" +
	"\rgateway_class\x18\x03 \x01(\tR\fgatewayClass\x12\x1c\n" +
	"\taddresses\x18\x04 \x03(\tR\taddresses\x12D\n" +
	"\tlisteners\x18\x05 \x03(\v2&.straitgateway.gateway.v1.ListenerInfoR\tlisteners\x12\x14\n" +
	"\x05ready\x18\x06 \x01(\bR\x05ready\"s\n" +
	"\fListenerInfo\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1a\n" +
	"\bprotocol\x18\x02 \x01(\tR\bprotocol\x12\x12\n" +
	"\x04port\x18\x03 \x01(\rR\x04port\x12\x1f\n" +
	"\vroute_count\x18\x04 \x01(\rR\n" +
	"routeCount\"K\n" +
	"\x11ListRoutesRequest\x12\x18\n" +
	"\agateway\x18\x01 \x01(\tR\agateway\x12\x1c\n" +
	"\tnamespace\x18\x02 \x01(\tR\tnamespace\"Q\n" +
	"\x12ListRoutesResponse\x12;\n" +
	"\x06routes\x18\x01 \x03(\v2#.straitgateway.gateway.v1.RouteInfoR\x06routes\"\xbb\x01\n" +
	"\tRouteInfo\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1c\n" +
	"\tnamespace\x18\x02 \x01(\tR\tnamespace\x12\x12\n" +
	"\x04type\x18\x03 \x01(\tR\x04type\x12%\n" +
	"\x0eparent_gateway\x18\x04 \x01(\tR\rparentGateway\x12\x1c\n" +
	"\thostnames\x18\x05 \x03(\tR\thostnames\x12#\n" +
	"\rbackend_count\x18\x06 \x01(\rR\fbackendCount2\xe8\x01\n" +
	"\x0eGatewayService\x12m\n" +
	"\fListGateways\x12-.straitgateway.gateway.v1.ListGatewaysRequest\x1a..straitgateway.gateway.v1.ListGatewaysResponse\x12g\n" +
	"\n" +
	"ListRoutes\x12+.straitgateway.gateway.v1.ListRoutesRequest\x1a,.straitgateway.gateway.v1.ListRoutesResponseB\xed\x01\n" +
	"\x1ccom.straitgateway.gateway.v1B\fGatewayProtoP\x01Z=github.com/msaeedb40/straitgateway/proto/gateway/v1;gatewayv1\xa2\x02\x03SGX\xaa\x02\x18Straitgateway.Gateway.V1\xca\x02\x18Straitgateway\\Gateway\\V1\xe2\x02$Straitgateway\\Gateway\\V1\\GPBMetadata\xea\x02\x1aStraitgateway::Gateway::V1b\x06proto3"
