...
const file_policy_v1_policy_proto_rawDesc = "" +
	"\n" +
	"\x16policy/v1/policy.proto\x12\x17straitgateway.policy.v1\"3\n" +
	"\x13ListPoliciesRequest\x12\x1c\n" +
	"\tnamespace\x18\x01 \x01(\tR\tnamespace\"Q\n" +
	"\x14ListPoliciesResponse\x129\n" +
	"\x05rules\x18\x01 \x03(\v2#.straitgateway.policy.v1.PolicyRuleR\x05rules\"\xdb\x01\n" +
	"\n" +
	"PolicyRule\x12!\n" +
	"\fsrc_identity\x18\x01 \x01(\rR\vsrcIdentity\x12!\n" +
	"\fdst_identity\x18\x02 \x01(\rR\vdstIdentity\x12\x19\n" +
	...
	"\tdirection\x18\a \x01(\tR\tdirection\"\x94\x01\n" +
	"\x15EvaluatePolicyRequest\x12!\n" +
	"\fsrc_identity\x18\x01 \x01(\rR\vsrcIdentity\x12!\n" +
	"\fdst_identity\x18\x02 \x01(\rR\vdstIdentity\x12\x19\n" +
	"\bdst_port\x18\x03 \x01(\rR\adstPort\x12\x1a\n" +
	"\bprotocol\x18\x04 \x01(\tR\bprotocol\"m\n" +
	...
	"policyName2\xef\x01\n" +
	"\rPolicyService\x12k\n" +
	"\fListPolicies\x12,.straitgateway.policy.v1.ListPoliciesRequest\x1a-.straitgateway.policy.v1.ListPoliciesResponse\x12q\n" +
	"\x0eEvaluatePolicy\x12..straitgateway.policy.v1.EvaluatePolicyRequest\x1a/.straitgateway.policy.v1.EvaluatePolicyResponseB\xe5\x01\n" +
	"\x1bcom.straitgateway.policy.v1B\vPolicyProtoP\x01Z;github.com/msaeedb40/straitgateway/proto/policy/v1;policyv1\xa2\x02\x03SPX\xaa\x02\x17Straitgateway.Policy.V1\xca\x02\x17Straitgateway\\Policy\\V1\xe2\x02#Straitgateway\\Policy\\V1\\GPBMetadata\xea\x02\x19Straitgateway::Policy::V1b\x06proto3"
