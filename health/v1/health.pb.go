...
type HealthCheckResponse struct {
	state         protoimpl.MessageState            `protogen:"open.v1"`
	Status        HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=straitgateway.health.v1.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_health_v1_health_proto_rawDesc = "" +
	"\n" +
	"\x16health/v1/health.proto\x12\x17straitgateway.health.v1\".\n" +
	"\x12HealthCheckRequest\x12\x18\n" +
	"\aservice\x18\x01 \x01(\tR\aservice\"\xba\x01\n" +
	"\x13HealthCheckResponse\x12R\n" +
	"\x06status\x18\x01 \x01(\x0e2:.straitgateway.health.v1.HealthCheckResponse.ServingStatusR\x06status\"O\n" +
	"\rServingStatus\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\v\n" +
	"\aSERVING\x10\x01\x12\x0f\n" +
	"\vNOT_SERVING\x10\x02\x12\x13\n" +
	"\x0fSERVICE_UNKNOWN\x10\x032\xd9\x01\n" +
	"\rHealthService\x12b\n" +
	"\x05Check\x12+.straitgateway.health.v1.HealthCheckRequest\x1a,.straitgateway.health.v1.HealthCheckResponse\x12d\n" +
	"\x05Watch\x12+.straitgateway.health.v1.HealthCheckRequest\x1a,.straitgateway.health.v1.HealthCheckResponse0\x01B\xe5\x01\n" +
	"\x1bcom.straitgateway.health.v1B\vHealthProtoP\x01Z;github.com/msaeedb40/straitgateway/proto/health/v1;healthv1\xa2\x02\x03SHX\xaa\x02\x17Straitgateway.Health.V1\xca\x02\x17Straitgateway\\Health\\V1\xe2\x02#Straitgateway\\Health\\V1\\GPBMetadata\xea\x02\x19Straitgateway::Health::V1b\x06proto3"
...
var file_health_v1_health_proto_goTypes = []any{
	(HealthCheckResponse_ServingStatus)(0), // 0: straitgateway.health.v1.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: straitgateway.health.v1.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: straitgateway.health.v1.HealthCheckResponse
}
var file_health_v1_health_proto_depIdxs = []int32{
	0, // 0: straitgateway.health.v1.HealthCheckResponse.status:type_name -> straitgateway.health.v1.HealthCheckResponse.ServingStatus
	1, // 1: straitgateway.health.v1.HealthService.Check:input_type -> straitgateway.health.v1.HealthCheckRequest
	1, // 2: straitgateway.health.v1.HealthService.Watch:input_type -> straitgateway.health.v1.HealthCheckRequest
	2, // 3: straitgateway.health.v1.HealthService.Check:output_type -> straitgateway.health.v1.HealthCheckResponse
	2, // 4: straitgateway.health.v1.HealthService.Watch:output_type -> straitgateway.health.v1.HealthCheckResponse
